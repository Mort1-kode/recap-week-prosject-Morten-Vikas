...
for (let topSeller of topSellers) {
  const container = document.createElement("div");
  container.classList.add("card");

  const logo = document.createElement("img");
  logo.src = `./logos/${topSeller.logo}`;
  logo.classList.add("logo-image");

  const title = document.createElement("h3");
  title.textContent = topSeller.title;
  title.classList.add("title");

  const developer = document.createElement("p");
  developer.textContent = topSeller.developer;
  developer.classList.add("devoloper");

  const categories = document.createElement("p");
  categories.textContent = topSeller.categories;
  categories.classList.add("categories");

  const releaseYear = document.createElement("p");
  releaseYear.textContent = topSeller.releaseYear;
  releaseYear.classList.add("realese");

  const platforms = document.createElement("p");
  platforms.textContent = topSeller.platforms;
  platforms.classList.add("platforms");

  const description = document.createElement("p");
  description.textContent = topSeller.description;
